...
- [x] **433** - Minimum Genetic Mutation (最小基因变化)
- [x] **909** - Snakes and Ladders (蛇梯棋)

### 贪心/边界问题
- [x] **3531** - Count Buildings Surrounded by Buildings (统计被其他建筑包围的建筑)
...
- Minimum Genetic Mutation (433) - BFS最短路径，哈希表O(1)优化visited
